  ...
  #__RA__
{
 ...
 "Was bedeuten die Cache Zustände Modified, Exclusive unmodified, Shared unmodified, Invalid?" => "(Exclusive) Modified\n- Cache ist der einzige, der diese Version des Werts beinhaltet\n- Andere Caches haben für diesen Wert den Zustand invalid\n\nExclusive Unmodified\n- Cache ist der einzige, der diesen Wert beinhaltet\n- Der Wert wurde nicht modifiziert\n\nShared Unmodified\n- Mehrere Caches beinhalten eine Kopie des Wertes\n- Der Wert wurde in keinem Cache bearbeitet\n\nInvalid\n- Ein anderer Cache hat den Wert bearbeitet und ist im Zustand Exclusive Modified",
 "Write After Write, Write After Read, Read After Write?" => "Write after write: 2 aufeinanderfolgende Befehle bearbeiten das gleiche Register\”Write after read: Eine Instruktion liest den Wert, die nächste bearbeitet den Wert\nRead after write: Eine instruktion beschreibt den Wert, die nächste liest ihn"
  # Fortsetzung folgt
},
