; Abgabe von: Ruth Höner zu Siedeedissen und Armin Kleinert

; Gianluca: What should I say... Very nice sollution the the assignement :D
; 3/3
...
formula_int_old:; get the 7th and 8th argument
		...
		mov eax, r10d	; eax = g
		cdq		; extends sign bit of eax in every bit of edx
		mov esi, 2
		idiv esi	; eax = (g/2)
		...
		; Gianluca: I belive that this sign extension is not neccessary.
		;			The sign should be set correctly by the multiplication
...
formula_int:	; get the 7th and 8th argument
		...
		; Gianluca: As in the former version: I belive that the cdq is
		;           uneccessary here
		cdq		; extends sign bit of eax in every bit of edx
		mov esi, 3
		idiv esi	; eax = eax / 3
